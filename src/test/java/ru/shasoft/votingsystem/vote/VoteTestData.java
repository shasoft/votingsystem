...
public class VoteTestData {
    ...
    public static final VoteCount voteCountForRestaurant1 = new VoteCount(date2024_11_05, RESTAURANT_ID_2, 1L);
    public static final VoteCount voteCountForRestaurant2 = new VoteCount(LocalDate.now(), RESTAURANT_ID_2, 1L);

    public static final VoteCount voteCountForDate1 = new VoteCount(LocalDate.now(), RESTAURANT_ID_2, 1L);
}

package ru.shasoft.votingsystem.user.web;
...
import ru.shasoft.votingsystem.user.repository.UserRepository;
...
import static ru.shasoft.votingsystem.user.web.AdminUserController.REST_URL;
import static ru.shasoft.votingsystem.user.web.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
